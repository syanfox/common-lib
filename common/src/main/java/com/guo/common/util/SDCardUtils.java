...
public final class SDCardUtils {
    ...
    public static String getSdcardPath(Application application) {
        ...
        if(Environment.getExternalStorageState() != null && Environment.getExternalStorageState().equals("mounted")) {
            path = "";
            if(Environment.getExternalStorageDirectory() != null && !StringUtils.isEmpty(Environment.getExternalStorageDirectory().getAbsolutePath())) {
            ...
            return StringUtils.isEmpty(path)?"/sdcard":application.getCacheDir().getPath();
        }
    }
}